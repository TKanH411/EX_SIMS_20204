...
namespace SIMS_SE06205.Controllers
{
    ...
    {
        private string filePathCourse = @"D:\DDD\APDP-BTec-main\data-sims\\data-courses.json";
        ...
        [HttpGet]
        public IActionResult DeleteCourse(int id = 0)
        {
            try
            {
                string dataJson = System.IO.File.ReadAllText(filePathCourse);
        ...
        [HttpGet]
        public IActionResult UpdateCourse(int id = 0)
        {
            string dataJson = System.IO.File.ReadAllText(filePathCourse);
            var courses = JsonConvert.DeserializeObject<List<CourseViewModel>>(dataJson);
        ...
        [HttpPost]
        public IActionResult UpdateCourse(CourseViewModel courseModel)
        {
            try
            {
                string dataJson = System.IO.File.ReadAllText(filePathCourse);
